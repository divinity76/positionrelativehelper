window.position_relative_helper = {
    ...
    update_panel: function () {
        ...
        var new_current_target = self.getUniqueSelector(self.current_target_);
        if (self.current_target_span.textContent !== new_current_target) {
            //turns out, writing to .textContent has side-effects, better not do it unless you need to..
    ...
    init: function () {
        ...
        self.current_target_left_minus_button.addEventListener("mousedown", function () {
            self.current_target_left_minus_button_interval_id = setInterval(self.current_target_left_minus_button_down, buttons_down_interval);
            self.current_target_left_minus_button_down();
        });
        ...
        self.current_target_left_plus_button.addEventListener("mousedown", function () {
            self.current_target_left_plus_button_interval_id = setInterval(self.current_target_left_plus_button_down, buttons_down_interval);
            self.current_target_left_plus_button_down();
        });
        ...
        self.current_target_top_plus_button.addEventListener("mousedown", function () {
            self.current_target_top_plus_button_interval_id = setInterval(self.current_target_top_plus_button_down, buttons_down_interval);
            self.current_target_top_plus_button_down();
        });
        ...
        self.current_target_top_minus_button.addEventListener("mousedown", function () {
            self.current_target_top_minus_button_interval_id = setInterval(self.current_target_top_minus_button_down, buttons_down_interval);
            self.current_target_top_minus_button_down();
        });
